        ...
        <div class="col">
          <div class="card h-100">
            <div class="position-relative overflow-hidden">
              <img src="https://picsum.photos/400/300?random={{ $index }}" class="card-img-top" alt="Kopi {{ $index }}"
            ...
            <div class="card-body p-4">
              <div class="d-flex justify-content-between align-items-start mb-3">
                <div>
                  <h5 class="card-title fw-bold mb-1">
                    <i class="bi bi-cup-hot text-warning me-2"></i>Kopi Premium {{ $index }}
                  </h5>
                  <div class="d-flex align-items-center">
                    <div class="text-warning me-2">
                      @for ($i = 1; $i <= 5; $i++) @if ($i <=(4 + ($index % 2))) <i class="bi bi-star-fill"></i>
                        @else
              ...
              <p class="card-text text-secondary mb-4">
                @if($index == 1)
                <i class="bi bi-flower1 text-success me-2"></i>Kopi dengan cita rasa khas dan aroma floral yang
                menenangkan.
                @elseif($index == 2)
                <i class="bi bi-lightning-charge text-warning me-2"></i>Kopi dengan karakter kuat dan kadar kafein
                tinggi.
                @elseif($index == 3)
                <i class="bi bi-heart text-danger me-2"></i>Perpaduan sempurna rasa manis dan asam seimbang.
                @else
                <i class="bi bi-gem text-primary me-2"></i>Kopi langka dengan kompleksitas rasa yang menakjubkan.
                @endif
              </p>
                ...
                <div class="row g-2">
                  <div class="col-6">
                    <div class="d-flex align-items-center">
                      ...
                      <small class="text-body-secondary">Roast: {{ ['Medium', 'Dark', 'Light', 'Medium-Dark'][$index-1]
                        }}</small>
                    </div>
                  </div>
                  <div class="col-6">
                  ...
                  <div class="col-6">
                    <div class="d-flex align-items-center">
                      ...
                      <small class="text-body-secondary">{{ ['Sumatra', 'Java', 'Bali', 'Toraja'][$index-1] }}</small>
                    </div>
                  </div>
                  <div class="col-6">
                    <div class="d-flex align-items-center">
                      <i class="bi bi-cup text-brown me-2"></i>
                      <small class="text-body-secondary">{{ ['Sedang', 'Kuat', 'Ringan', 'Sedang'][$index-1] }}
                        Body</small>
                    </div>
                  </div>
                </div>
