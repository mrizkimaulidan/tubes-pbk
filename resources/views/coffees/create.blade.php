        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('kopi.store') }}" method="POST" id="createForm">
                    ...
                    <div class="form-floating mb-3">
                        <input type="number" step="1000" min="0" class="form-control" name="price"
                            id="price" placeholder="Masukkan harga" required>
                    ...
                    <div class="mb-3">
                        <div class="form-floating">
                            ...
                            <label for="taste">Rasa<span class="text-danger">*</span></label>
                        </div>
                    </div>
                    <div class="mb-3">
                        <div class="form-floating">
                            ...
                            <label for="intensity">Intensitas<span class="text-danger">*</span></label>
                        </div>
                    </div>
                    <div class="mb-3">
                        <div class="form-floating">
                    ...
                    <div class="mb-3">
                        <div class="form-floating">
                            <select name="beans_type" id="beans_type" class="form-select" required>
                                ...
                                <option value="Banyak">Blend</option>
                            </select>
